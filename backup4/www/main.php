...
<div class="container" id="help" style="margin-top: 20px; display:none">
    <p style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspНачальная страница сайта представляет собой календарь, в котором можно создавать, редактировать и удалять записи, в дальнейшем будет использоваться термин «дела». С делами можно работать в пределах: месяца (задавать дату (даты)), недели (задавать день (дни)), дня (задавать час (часы)). Задавать временные промежутки можно в размерах от одной до нескольких временных единиц. Есть возможность просмотра прошедших, последующих дат, быстрый возврат на текущую дату.
    Создание дела осуществляется по нажатию левой кнопки мыши на нужной дате. Для выбора более продолжительного промежутка времени необходимо зажать левую кнопку мыши и вести курсором от начальной до конечной даты. Далее появиться окно, в котором можно создать дело. Редактирование осуществляется по тому же принципу.
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspВо вкладке «Notes» навигационного меню сайта можно создавать, редактировать, удалять заметки. Для создания записи необходимо написать текст заметки в текстовом поле и нажать кнопку «Add note». Для редактирования заметки необходимо нажать на значок редактирования на заметке, произвести изменения при помощи появившихся инструментов редактирования заметки и нажать кнопку «Edit note». Можно менять текст выбранной заметки, а также цвет её подложки. Для удаления заметки необходимо нажать на значок удаления на заметке. Заметки можно произвольно перемещать и задать расположение  в пределах их рабочей области. Данные действия производятся при зажатой левой кнопке мыши и перемещения курсора в пределах рабочей области для заметок.
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspВо вкладке «Home» представлены часы и виджет погоды для конкретно заданного региона, в данной версии программы: «Российская Федерация, Томская область, г. Томск». Часы показывают время, установленное на сервере, на котором запущен сайт.
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspВо вкладке «About» представлена информация об используемых при разработке программы технологиях. Для просмотра всех технологий предложено использовать нажатия на иконки «влево-вправо».
    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspДля более подробной информации воспользуйтесь документацией к программе.
    </p>
</div>
